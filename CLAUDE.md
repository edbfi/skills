...
5. Run `python3 .github/scripts/check-content.py`.
...
- Action refs (`edbfi/automation/...@v3.0.1`), hook `rev`s in `prek.toml`, and the prek version are Renovate-managed; leave bumps to Renovate PRs and keep the `# renovate:` comment in `.github/workflows/ci.yml`.
